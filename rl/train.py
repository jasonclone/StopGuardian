...
def init_models_and_replay(state_size, lr_decay_steps=None):
...
def run():
    ...
    lr_decay_steps = total_planned_updates if SCHEDULER_TYPE == "linear" else None
    ...
    try:
        for ep in range(NUM_EPISODES):
            ...
            if ep_mode == "train" and episode_ok:
                ...
                if SCHEDULER_TYPE == "plateau" and plateau_scheduler is not None:
